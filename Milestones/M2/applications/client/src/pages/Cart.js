...
=======
  ...
  let localCart = localStorage.getItem("cart");
  // console.log(cart)
>>>>>>> 03c7b5495a73ab68933427cd88c42f687d11ff14
            ...
            <div className="listingRight">
              ...
              <div className="totalPrice">
                ...
                {Number(value.subTotal) +
                  Number(value.depositFee) +
                  Number(value.shippingFee)}
              </div>
              <div className="startDate">
                Start Date: {new Date(value.startDate).toLocaleDateString()}
              </div>
              <div className="endDate">
                End Date: {new Date(value.endDate).toLocaleDateString()}
              </div>
              <button
                className="buyButton"
                onClick={() => completeTransaction(value)}
              >
