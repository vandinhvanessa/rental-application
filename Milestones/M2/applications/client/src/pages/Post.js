...
function Post() {
  ...
  const addToCart = (product) => {
    ...
    product.subTotal =
      (postObject.pricePerDay * Math.abs(endDate - startDate)) /
      (1000 * 60 * 60 * 24);
  ...
  const deleteComment = (id) => {
    axios
      .delete(`http://` + hostname + `/comments/${id}`, {
      ...
      <div className="rightSide">
        <div className="postInfo">
          <div className="postBuyButtons">
            <button className="buyButton" onClick={() => addToCart(postObject)}>
              Add To Cart
            </button>
          ...
          <div className="otherInfo">
            <div className="postCategory">Category: {postObject.category}</div>
            ...
            <div className="pricePerDay">$/Day: ${postObject.pricePerDay}</div>
