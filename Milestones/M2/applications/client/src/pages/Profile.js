...
function Profile() {
  ...
  const categories = [
    { value: "All", label: "All" },
    { value: "Bicycle Gear", label: "Bicycle Gear" },
    { value: "Climbing Gear", label: "Climbing Gear" },
    { value: "Electronics", label: "Electronics" },
    { value: "Garden", label: "Garden" },
    { value: "Hiking Gear", label: "Hiking Gear" },
    ...
    { value: "Snow Gear", label: "Snow Gear" },
      ...
      {listOfPosts
        .filter((value) => {
          if (searchTerm == "" && categoryTerm == "") {
            ...
            value.title.toLowerCase().includes(searchTerm.toLowerCase()) &&
            value.category.toLowerCase().includes(categoryTerm.toLowerCase())
          ) {
            return value;
          } else if (
            searchTerm == "" &&
        ...
        .map((value, key) => {
          return (
            ...
            >
              ...
              <div className="userDepositFee">
                Deposit Fee: {value.depositFee}
              </div>
              <div className="userShippingFee">
                Shipping Fee: {value.shippingFee}
              </div>
