...
exports.Rating = React.forwardRef(function (directProps, ref) {
    ...
    var handleKeyDown = React.useCallback(function (syntheticEvent) {
        ...
        switch (syntheticEvent.keyCode) {
            case kendo_react_common_1.Keys.right:
                ...
                dispatchStateValue({
                    type: dir === 'rtl' ? rating_reducer_1.RATING_ACTION.decrease : rating_reducer_1.RATING_ACTION.increase, event: syntheticEvent
                });
                break;
            case kendo_react_common_1.Keys.left:
                syntheticEvent.preventDefault();
                dispatchStateValue({
                    type: dir === 'rtl' ? rating_reducer_1.RATING_ACTION.increase : rating_reducer_1.RATING_ACTION.decrease, event: syntheticEvent
                });
                break;
            case kendo_react_common_1.Keys.home:
                syntheticEvent.preventDefault();
                dispatchStateValue({
                    type: dir === 'rtl' ? rating_reducer_1.RATING_ACTION.min : rating_reducer_1.RATING_ACTION.max, event: syntheticEvent
                });
                break;
            case kendo_react_common_1.Keys.end:
                syntheticEvent.preventDefault();
                dispatchStateValue({
                    type: dir === 'rtl' ? rating_reducer_1.RATING_ACTION.max : rating_reducer_1.RATING_ACTION.min, event: syntheticEvent
                });
                break;
            case kendo_react_common_1.Keys.esc:
                syntheticEvent.preventDefault();
                dispatchStateValue({
                    type: rating_reducer_1.RATING_ACTION.deselect, event: syntheticEvent
                });
                break;
            default:
                break;
    ...
    var handleItemMouseMove = React.useCallback(function (event) {
        ...
        if (precision === 'half') {
            ...
            dispatchStateHover({ type: rating_reducer_1.RATING_ACTION.select, payload: event.target.value, event: event.syntheticEvent });
        }
    }, [precision, step, dir]);
...
exports.Rating.displayName = 'KendoReactRating';
// TODO: delete casting when @types/react is updated!
exports.Rating.propTypes = propTypes;
exports.Rating.defaultProps = defaultProps;
