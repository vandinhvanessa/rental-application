        ...
        return (React.createElement("div", { onKeyDown: this.handleKeyDown, className: rootClassName, tabIndex: -1 },
            React.createElement("div", { className: "k-datetime-buttongroup" },
                React.createElement(kendo_react_buttons_1.ButtonGroup, { width: "100%" },
                    React.createElement(kendo_react_buttons_1.Button, { type: "button", selected: this.state.tab === 'date', togglable: true, onClick: this.handleDateClick }, dateMessage),
                    React.createElement(kendo_react_buttons_1.Button, { type: "button", selected: this.state.tab === 'time', togglable: true, onClick: this.handleTimeClick }, timeMessage))),
